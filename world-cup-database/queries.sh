...
echo "$($PSQL "SELECT DISTINCT(teams.name) FROM teams INNER JOIN games AS g1 ON g1.winner_id = teams.team_id OR g1.opponent_id = teams.team_id WHERE g1.year = 2014 AND g1.round = 'Eighth-Final'")"
