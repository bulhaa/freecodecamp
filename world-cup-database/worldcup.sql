...
ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_opponent_id_fkey FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_winner_id_fkey FOREIGN KEY (winner_id) REFERENCES public.teams(team_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
